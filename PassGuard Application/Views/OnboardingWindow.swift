...
struct OnboardingWindow: View {
    ...
    var body: some View {
        VStack {
            ...
            If the account has not been created, this view will be shown. Otherwise, the user will be directed to the Login Screen.*/
            ...
            if !AccountExists() {
                ...
                // This opens the login window if an account has already been created
                LoginWindow()
